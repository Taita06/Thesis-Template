...
% Ngày điều chỉnh: 24/03/2024
 ...
 %In 1 mặt: oneside
 %In 2 mặt: twoside
 \documentclass[a4paper,titlepage,oneside,openright,11pt]{book}
 %Kích thước chữ:
...
%  \tikzexternalize[prefix=fig_tikz/]   
 % need using "pdflatex -shell-escape <mainfile>.tex" for the first compiling. Make sure the folder "fig_tikz" is empty. 
...
\authorEN{Author name} %tên tác giả tiếng anh
\studentid{studentID}
